...
class WOFHumanPlayer(WOFPlayer):
    ...
    def getMove(self, category, obscuredPhrase, guessed):
        print("{} has ${}".format(WOFPlayer.name, WOFPlayer.prizeMoney))
        print("Category:  {} \n Phrase: {} \n Guessed: {}\n".format(self.category,self.obscuredPhrase,self.guessed))
        print("Guess a letter, phrase, or type 'exit' or 'pass' ")
        move = str(input())
        return move
#mi sa che ci vuole un caso IF ELSE per il tipo di input e forse un do while per continuare a fare l'inserimento finchè non si esce :D    
