"""
Challenge: Write code to assign to the variable class_sched all the values of the key important classes. 
...
info = tester["info"]
class_sched = [dic["important classes"] for dic in info ]
